...
- dialog:
  ...
  - paragraph: In this bug, the yellow and orange colors of the product are misspelled.
  - separator
  ...
  - list:
    ...
    - listitem: Open a product with color options
    - listitem: Choose the Yellow and Orange colors
  - heading "Expected Result" [level=6]
  - paragraph: The yellow and orange colors are spelled correctly
  - heading "Actual Result" [level=6]
  - paragraph: Yellow is misspelled as "Yelow" and Orange as "Orang"
